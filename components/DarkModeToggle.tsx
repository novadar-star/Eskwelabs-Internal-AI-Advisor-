 ...
 * Uses next-themes' useTheme hook — must be a Client Component.
 *
 * The `mounted` guard prevents hydration mismatch: on the server we don't
 * know the theme yet, so we render nothing until the client mounts.
 */
...
export default function DarkModeToggle() {
  ...
  if (!mounted) return <div className="h-8 w-8" />; // placeholder to prevent layout shift
